    ...
    */
	...
	function resizeColumns() {
	 ...
	 function resetColumns() {
		gridLayoutItems = gridLayout.children('.post');
    ...
    var methods = {
        init : function(options) {
            ...
            $(this).children('div, section, article, img, a').addClass('post');
            gridLayout = $(this);
            gridLayoutItems = gridLayout.children('.post');
        ...
        addAfter : function(itemArray) {
			...
			for(var i=0; i < itemArray.length; i++) {
				var newItem  = $(itemArray[i]).addClass('post');
			...
			if(!gridLayout.hasClass('no-grid')) {
				columns = resizeColumns();
				createColumns(columns);
			} else{ style(gridLayout.children('.post')); }
